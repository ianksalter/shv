...
baseline_start = FreeCAD.Vector(175, 7900, 250)
baseline_end = FreeCAD.Vector(175, 11960, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_3')
new_structure.addObject(wall)

baseline_start = FreeCAD.Vector(175, 12360, 250)
baseline_end = FreeCAD.Vector(175, 15690, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_4')
new_structure.addObject(wall)

baseline_start = FreeCAD.Vector(175, 16090, 250)
baseline_end = FreeCAD.Vector(175, 16730, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_5')
new_structure.addObject(wall)

baseline_start = FreeCAD.Vector(110, 16795, 250)
baseline_end = FreeCAD.Vector(2390, 16795, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_6')
new_structure.addObject(wall)

baseline_start = FreeCAD.Vector(2670, 16795, 250)
baseline_end = FreeCAD.Vector(6180, 16795, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_7')
new_structure.addObject(wall)

baseline_start = FreeCAD.Vector(6115, 12100, 250)
baseline_end = FreeCAD.Vector(6115, 16730, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_8')
new_structure.addObject(wall)

baseline_start = FreeCAD.Vector(4070, 12165, 250)
baseline_end = FreeCAD.Vector(6050, 12165, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_9')
new_structure.addObject(wall)

baseline_start = FreeCAD.Vector(4305, 7500, 250)
baseline_end = FreeCAD.Vector(4305, 12100, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_10')
new_structure.addObject(wall)

baseline_start = FreeCAD.Vector(4240, 7435, 250)
baseline_end = FreeCAD.Vector(4790, 7435, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_11')
new_structure.addObject(wall)

baseline_start = FreeCAD.Vector(4725, 4160, 250)
baseline_end = FreeCAD.Vector(4725, 7370, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_12')
new_structure.addObject(wall)

baseline_start = FreeCAD.Vector(4865, 390, 250)
baseline_end = FreeCAD.Vector(4865, 3760, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_13')
new_structure.addObject(wall)
...
baseline_start = FreeCAD.Vector(1995, 520, 250)
baseline_end = FreeCAD.Vector(1995, 4520, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_Bed_1_1')
new_structure.addObject(wall)

baseline_start = FreeCAD.Vector(1460, 4585, 250)
baseline_end = FreeCAD.Vector(4660, 4585, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_Bed_1_2')
new_structure.addObject(wall)

baseline_start = FreeCAD.Vector(1525, 4650, 250)
baseline_end = FreeCAD.Vector(1525, 9580, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_Bed_2_1')
new_structure.addObject(wall)

baseline_start = FreeCAD.Vector(1590, 8945, 250)
baseline_end = FreeCAD.Vector(4240, 8945, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
wall = Arch.makeWall(baseline, length=None, width=130, height=2600, name='Steel_Wall_Bed_2_2')
new_structure.addObject(wall)
