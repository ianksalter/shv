...
baseline_start = FreeCAD.Vector(215, 3675, 250)
baseline_end = FreeCAD.Vector(1950, 3675, 250)
baseline = Draft.makeLine(baseline_start, baseline_end)
